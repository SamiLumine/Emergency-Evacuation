...
namespace LudicWorlds
{
    public class DebugPanel : MonoBehaviour
    {
        ...
        private void AcquireObjects()
        {
            ...
            //_debugText = ui.Find("Scroll View").GetChild(0).GetChild(0).Find("DebugText").GetComponent<Text>();
            _debugText = ui.Find("Scroll View").GetChild(0).GetChild(0).GetComponent<Text>();
